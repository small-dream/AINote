...
| 日期 | 变更 | 作者 |
|---|---|---|
| 2026-09-10 | v1.1：证书 / 签名类任务（E1-T1/T2/T4）暂缓至 M1.5，M1 聚焦可诊断、可恢复、同步可靠与度量；重排 Wave 0–4 与发布门禁；M1-E4-T1 交付（SYNC_4002/4003/4004 + 前端可操作提示）；M1-E2-T1 交付（结构化日志 + 全局脱敏） | PM |
