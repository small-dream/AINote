...
| P1-6 | 移动端支持（iOS/Android，Tauri 2 Mobile） | 首版覆盖 GitHub 授权、仓库 clone 到应用沙盒、离线浏览/编辑、本地 commit、前台恢复同步、笔记树/搜索/标签/收藏/回收站、附件导入和移动端单栏编辑器；不承诺任意本地路径绑定、进程终止后的后台同步、移动端自动更新和桌面式打印。详细计划见 `docs/MOBILE_PLAN.md` |
