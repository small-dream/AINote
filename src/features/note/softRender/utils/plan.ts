...
const NODE_HANDLERS: Record<string, NodeHandler> = {
  ...
  StrongEmphasis: (n, _d, c, p, s) => planMarkedPair(n, "EmphasisMark", "cm-sr-strong", c, p, s),
  Emphasis: (n, _d, c, p, s) => planMarkedPair(n, "EmphasisMark", "cm-sr-em", c, p, s),
  Strikethrough: (n, _d, c, p, s) => planMarkedPair(n, "StrikethroughMark", "cm-sr-strike", c, p, s),
