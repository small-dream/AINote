...
export function selectOutline(item: OutlineItem, mode: ViewMode, editorView: EditorView | null, preview: HTMLDivElement | null): void {
  ...
  if (mode === "split" || mode === "preview") scrollPreviewToHeading(preview, item);
}
