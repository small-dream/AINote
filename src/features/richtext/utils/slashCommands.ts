...
export const SLASH_COMMANDS: SlashCommandDef[] = [
  ...
  { key: "h4", labelKey: "richtext.h4", icon: Heading4, keywords: ["heading", "标题", "h4"], run: (e) => void e.chain().focus().toggleHeading({ level: 4 }).run() },
  { key: "h5", labelKey: "richtext.h5", icon: Heading5, keywords: ["heading", "标题", "h5"], run: (e) => void e.chain().focus().toggleHeading({ level: 5 }).run() },
  { key: "h6", labelKey: "richtext.h6", icon: Heading6, keywords: ["heading", "标题", "h6"], run: (e) => void e.chain().focus().toggleHeading({ level: 6 }).run() },
