...
export function TodoWorkspace({ repoPath }: { repoPath: string | null }) {
  ...
  return (
    <div className="flex h-full min-h-0 flex-1 overflow-hidden bg-bg-primary">
      <aside className="flex h-full w-[320px] shrink-0 flex-col overflow-hidden border-r border-border bg-bg-secondary">
